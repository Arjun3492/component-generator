...
export const ProjectProvider = ({ children }) => {
    ...
    return (
        <ProjectContext.Provider value={{ currentProject, setCurrentProject, projects, setProjects, handleCreateProject, fetchProjectWithAttributes, updateCacheWithEditedValue }}>
            {children}
